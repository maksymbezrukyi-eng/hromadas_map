...
const INDICATOR_META = {
  d1: {maxPoints:10, valueType:'other', desc:{uk:'Сирий бал домену 1 (сума підпоказників 1.1–1.4, максимум 10). Зважений внесок у підсумкову оцінку — 20%, макс. 2,0 бала.'}},
  d2: {maxPoints:10, valueType:'other', desc:{uk:'Сирий бал домену 2 (сума підпоказників 2.1–2.4, максимум 10). Зважений внесок у підсумкову оцінку — 10%, макс. 1,0 бал.'}},
  d3: {maxPoints:10, valueType:'other', desc:{uk:'Сирий бал домену 3 (сума підпоказників 3.1–3.3, максимум 10). Зважений внесок у підсумкову оцінку — 15%, макс. 1,5 бала.'}},
  d4: {maxPoints:10, valueType:'other', desc:{uk:'Сирий бал домену 4 (сума підпоказників 4.1–4.3, максимум 10). Зважений внесок у підсумкову оцінку — 10%, макс. 1,0 бал.'}},
  d5: {maxPoints:10, valueType:'other', desc:{uk:'Сирий бал домену 5 (сума підпоказників 5.1–5.2, максимум 10). Зважений внесок у підсумкову оцінку — 5%, макс. 0,5 бала.'}},
  d6: {maxPoints:10, valueType:'other', desc:{uk:'Сирий бал домену 6 (сума підпоказників 6.1–6.5, максимум 10). Зважений внесок у підсумкову оцінку — 10%, макс. 1,0 бал.'}},
  d4a: {maxPoints:10, valueType:'other', desc:{uk:'Сирий бал домену 7 (сума підпоказників 7.1–7.3, максимум 10). Зважений внесок у підсумкову оцінку — 10%, макс. 1,0 бал.'}},
